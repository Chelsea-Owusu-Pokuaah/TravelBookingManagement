...
function getCancelledBookingCount() {
    global $conn;
    $userID = userIdExist();
    $cancelledQuery = "SELECT COUNT(*) as cancelled_count FROM BookingRequest JOIN RequestsEmployees ON RequestsEmployees.requestID = BookingRequest.requestID WHERE employeeID = '$userID' AND statusID = (SELECT status_ID FROM Status WHERE status_name = 'Cancelled')";
...
function getBookedBookingCount() {
    global $conn;
    $userID = userIdExist();
    $bookedQuery = "SELECT COUNT(*) as booked_count FROM BookingRequest JOIN RequestsEmployees ON RequestsEmployees.requestID = BookingRequest.requestID WHERE employeeID = '$userID'  AND statusID = (SELECT status_ID FROM Status WHERE status_name = 'Booked')";
...
function getRequestedBookingCount() {
    global $conn;
    $userID = userIdExist();
    $requestedQuery = "SELECT COUNT(*) as requested_count FROM BookingRequest JOIN RequestsEmployees ON RequestsEmployees.requestID = BookingRequest.requestID WHERE employeeID = '$userID'  AND statusID = (SELECT status_ID FROM Status WHERE status_name = 'Requested')";
